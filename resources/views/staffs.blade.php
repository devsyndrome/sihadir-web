    ...
    <div class="section-body">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="staffs-table" class="table table-striped table-bordered table-sm">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="id" class="col-sm-12 control-label">Staff ID</label>
                                <div class="col-sm-12">
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('staffs.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            // var oTable = $('#staffs-table').dataTable();
        ...
        $('body').on('click', '.edit-post', function () {
          $("#id").attr('readonly', true)
            ...
            $.get('staffs/' + data_id + '/edit', function (data) {
                ...
                $('#birthdate').val(data.staff_birthdate);
                $('#birthplace').val(data.staff_birthplace);
                $('#gender').val(data.staff_gender);
                $('#address').val(data.staff_address);
                $('#phonenumber').val(data.staff_phonenumber);
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "staffs/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
