                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          ...
                          <input type="hidden" name="id" id="id">
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-12 control-label">Credits</label>
                              <div class="col-sm-12">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#Classes-table').DataTable({
        ...
        columns: [
          ...
          {data: 'course_credits', name: 'course_credits'},
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('courses.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('courses/' + data_id + '/edit', function (data) {
                $('#modal-judul').html("Edit Class");
                $('#tombol-simpan').val("edit-post");
                $('#tambah-edit-modal').modal('show');

                //set value masing-masing id berdasarkan data yg diperoleh dari ajax get request diatas               
                $('#id').val(data.course_id);
                $('#name').val(data.course_name);
                $('#credits').val(data.course_credits);
            })
        });
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "courses/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
