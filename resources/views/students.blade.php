    ...
    <div class="section-body">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table id="students-table" class="table table-striped table-bordered table-sm">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
              ...
              {{-- <tbody>
                @foreach ($list_students as $data)
                    <tr>
                      <td>{{$data->student_id}}</td>
                      <td>{{$data->student_name}}</td>
                      <td>{{$data->student_birthdate}}</td>
                      <td>{{$data->student_birthplace}}</td>
                      <td>{{$data->student_gender}}</td>
                      <td>{{$data->student_address}}</td>
                      <td>{{$data->student_phonenumber}}</td>
...
integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#students-table').DataTable({
        ...
        columns: [
          ...
          {data: 'student_phonenumber', name: 'student_phonenumber'},
    ...
    //TOMBOL TAMBAH DATA
            ...
            $('#modal-judul').html("Add or edit student"); //valuenya tambah pegawai baru
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
          ...
          $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('students.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
          $("#id").attr('readonly', true)
            ...
            $.get('students/' + data_id + '/edit', function (data) {
                $('#modal-judul').html("Edit student");
                ...
                $('#birthdate').val(data.student_birthdate);
                $('#birthplace').val(data.student_birthplace);
                $('#gender').val(data.student_gender);
                $('#address').val(data.student_address);
                $('#phonenumber').val(data.student_phonenumber);
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "students/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
