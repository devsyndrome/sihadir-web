                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            <label for="name" class="col-sm-12 control-label">Prody</label>
                            <div class="col-sm-12">
                              {!! Form::select('prody_id', $prody, null, ['class' => 'form-control required', 'name' => 'prody_id', 'id' => 'prody_id']) !!}
                            </div>
                        </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-12 control-label">Semester</label>
                              <div class="col-sm-12">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#Classes-table').DataTable({
        ...
        columns: [
          ...
          {data: 'studyprogram.prody_name', name: 'studyprogram.prody_name'},
          {data: 'class_name', name: 'class_name'},
          {data: 'class_semester', name: 'class_semester'},
    ...
    //TOMBOL TAMBAH DATA
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Add new Class"); //valuenya tambah pegawai baru
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('classes.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('classes/' + data_id + '/edit', function (data) {
                ...
                $('#prody_id').val(data.prody_id);
                $('#name').val(data.class_name);
                $('#semester').val(data.class_semester);
            })
        });
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "classes/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
