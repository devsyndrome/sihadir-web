                        ...
                        <div class="col-sm-12">
                          ...
                          <input type="hidden" name="id" id="id">
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-12 control-label">Classroom Name</label>
                              <div class="col-sm-12">
  ...
  <script type="text/javascript">
    ...
    //TOMBOL TAMBAH DATA
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Add new classroom"); //valuenya tambah pegawai baru
    ...
    //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('classrooms.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            // var oTable = $('#classrooms-table').dataTable();
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('classrooms/' + data_id + '/edit', function (data) {
                $('#modal-judul').html("Edit classroom");
                $('#tombol-simpan').val("edit-post");
                $('#tambah-edit-modal').modal('show');

                //set value masing-masing id berdasarkan data yg diperoleh dari ajax get request diatas               
                $('#id').val(data.classroom_id);
                $('#name').val(data.classroom_name);
            })
        });
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "classrooms/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
